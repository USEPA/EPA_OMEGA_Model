...
class MarketClass(OMEGABase, MarketClassBase):
    ...
    market_categories = ['ICE', 'BEV', 'PHEV', 'sedan_wagon_r1nonzev', 'cuv_suv_van_r1nonzev', 'pickup_r1nonzev',
    ...
    def get_linestyle(varname):
        ...
        elif 'PHEV' in varname_split:
            style_dict['color'] = '#0EC538'
    ...
    def get_vehicle_market_class(vehicle):
        ...
        if vehicle.body_style == 'sedan_wagon_r1nonzev':
            if vehicle.base_year_powertrain_type in ['BEV', 'FCV']:
                ...
                market_class_id = 'sedan_wagon_r1nonzev.PHEV'
            else:
            ...
            if vehicle.base_year_powertrain_type in ['BEV', 'FCV']:
                ...
                market_class_id = 'cuv_suv_van_r1nonzev.PHEV'
            else:
            ...
            if vehicle.base_year_powertrain_type in ['BEV', 'FCV']:
                ...
                market_class_id = 'sedan_wagon_r2zev.PHEV'
            else:
            ...
            if vehicle.base_year_powertrain_type in ['BEV', 'FCV']:
                ...
                market_class_id = 'cuv_suv_van_r2zev.PHEV'
            else:
            ...
            if vehicle.base_year_powertrain_type in ['BEV', 'FCV']:
                ...
                market_class_id = 'pickup_r2zev.PHEV'
            else:
