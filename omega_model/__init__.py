...
try:
    ...
    class OMEGASessionSettings(OMEGABase):
        ...
        def __init__(self):
            ...
            self.producer_consumer_max_iterations = 4  # recommend 2+
            ...
            self.battery_GWh_limit = [12, 12, 12, 134, 159, 190, 250, 356, 502, 651, 792, 936, 1080, 1224, 1364, 1500, 1500, 1500, 1500, 1500, 1500]
