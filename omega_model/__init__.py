    ...
    class OMEGASessionSettings(OMEGABase):
        ...
        def __init__(self):
            ...
            self.verbose_log_modules = ['database_', 'producer_compliance_search_', 'cross_subsidy_search_',
                                        'cv_cost_curves', 'v_cost_curves_', 'v_cost_clouds', 'v_cloud_plots']
            ...
            self.log_vehicle_cloud_years = [2022]  # = 'all' or list of years to log, empty list to disable logging
            self.log_producer_compliance_search_years = []  # = 'all' or list of years to log, empty list to disable logging
            self.log_consumer_iteration_years = [2022]  # = 'all' or list of years to log, empty list to disable logging
