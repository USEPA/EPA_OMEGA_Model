...
class OMEGASessionObject(OMEGABase):
    ...
    def get_io_settings(self, remote=False):
        ...
        self.settings.policy_reg_classes_input_file = self.read_parameter('Regulatory Classes File')
        self.settings.policy_targets_input_file = self.read_parameter('GHG Standards File')
        self.settings.policy_fuels_file = self.read_parameter('GHG Standards Fuels File')
