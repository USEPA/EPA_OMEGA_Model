...
class VehicleFinal(SQABase, Vehicle):
    ...
    **Loads the base year vehicle data and stores finalized vehicles in the database.**
    ...
    base_input_template_columns = {'vehicle_name','manufacturer_id','model_year','reg_class_id','context_size_class','electrification_class','in_use_fuel_id','cert_fuel_id','sales','footprint_ft2','eng_rated_hp','etw_lbs','msrp_dollars','unibody_structure','body_style','structure_material','drive_system','curbweight_lbs','high_eff_alternator','start_stop','hev','phev','bev','deac_pd','deac_fc','cegr','atk2','gdi','turb12','turb11','gas_fuel','diesel_fuel','target_coef_a','target_coef_b','target_coef_c'}  #: mandatory input file columns, the rest can be optional numeric columns
                                    # TODO: , 'battery_kwh'
