...
import datetime
import numpy as np
def Subconfig_ModelType_Footprint_Bodyid_Expansion_SL(input_path, footprint_filename, footprint_lineage_filename, bodyid_filename, \
    ...
    try:
        ...
        if bool_run_new_manual_filter == 'n':
            ...
            output_array = Calculate_Powertrain_Efficiency_SL.Calculate_Powertrain_Efficiency_SL(\
                vehghg_file_nonflexfuel['TEMP_ID'], vehghg_file_nonflexfuel['TEST_PROC_CATEGORY'], vehghg_file_nonflexfuel['TARGET_COEF_A'], vehghg_file_nonflexfuel['TARGET_COEF_B'], \
                vehghg_file_nonflexfuel['TARGET_COEF_C'], vehghg_file_nonflexfuel['VEH_ETW'], vehghg_file_nonflexfuel['TEST_UNROUNDED_UNADJUSTED_FE'], \
                input_path, drivecycle_filenames, drivecycle_input_filenames, drivecycle_output_filenames, vehghg_file_nonflexfuel['ENG_DISPL'].astype(float), vehghg_file_nonflexfuel['ENG_RATED_HP'], \
                vehghg_file_nonflexfuel['FUEL_NET_HEATING_VALUE_MJPL'])
            # vehghg_file_nonflexfuel['EPA_CAFE_MT_CALC_COMB_FE_4'], vehghg_file_nonflexfuel['TEST_UNROUNDED_UNADJUSTED_FE'], \
