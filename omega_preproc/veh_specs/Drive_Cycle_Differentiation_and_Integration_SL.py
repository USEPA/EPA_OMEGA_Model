def Drive_Cycle_Differentiation_and_Integration_SL(input_path, drivecycle_filenames, drivecycle_input_filenames, drivecycle_output_filenames):
    import pandas as pd
    import numpy as np
...
#Read in FTP and HWFET drive cycle
    ...
    return (FTP_Array, HWFET_Array, US06_Array)