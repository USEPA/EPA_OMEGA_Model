...
from effects.inventory import calc_vehicle_co2_gallons, calc_vehicle_inventory, calc_refinery_inventory
...
refinery_factors = ['voc', 'co', 'nox', 'pm25', 'sox', 'benzene', 'butadiene', 'formaldehyde', 'acetaldehyde', 'acrolein', 'naphthalene',
                    'ch4', 'n2o', 'co2']
