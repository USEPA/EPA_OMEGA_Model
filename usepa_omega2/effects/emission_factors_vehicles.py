...
class EmissionFactorsVehicles(SQABase):
    ...
    co_grams_per_mile = Column('low-co_grams_per_mile', Numeric)
    nox_grams_per_mile = Column('high-nox_grams_per_mile', Numeric)
    ...
    def init_database_from_file(filename, verbose=False):
        ...
        input_template_columns = {'model_year', 'age', 'reg_class_id', 'in_use_fuel_id',
                                  'voc_grams_per_mile', 'co_grams_per_mile', 'nox_grams_per_mile', 'pm25_grams_per_mile',
                                  ...
                                  'ch4_grams_per_mile', 'n2o_grams_per_mile', 'sox_grams_per_gallon'}
