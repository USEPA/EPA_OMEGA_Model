    ...
    for calendar_year in range(o2.options.analysis_initial_year, o2.options.analysis_final_year + 1):
        ...
        for pass_num in range(1,3):
            for market_class_id in market_class_ids:
                ...
                vehicle_demanded_sales_annual_data = o2.session.query(DemandedSharesGCAM).filter(DemandedSharesGCAM.calendar_year == calendar_year).filter(DemandedSharesGCAM.market_class_ID == market_class_id[0])
...
if __name__ == '__main__':
    ...
    init_fail = init_fail + DemandedSharesGCAM.init_database_from_file(o2.options.demanded_sales_annual_data_file, verbose=o2.options.verbose)
