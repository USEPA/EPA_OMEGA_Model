...
class OMEGASessionObject(OMEGABase):
    ...
    def get_io_settings(self, remote=False):
        ...
        self.settings.fuel_upstream_file = self.read_parameter('Policy Fuel Upstream File')
        ...
        self.settings.ghg_standards_sales_incentives_file = self.read_parameter('GHG Standards Sales Incentives File')
