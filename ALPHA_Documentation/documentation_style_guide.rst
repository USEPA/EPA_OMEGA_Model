...
Tables
------
First task is to enable numbering in the conf.py file:
...
If the optional marker (mylabel) is included, the table can be cross referenced using the following syntax (the marker must be preceded by an underscore as shown above):
