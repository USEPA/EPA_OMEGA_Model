...
.. admonition:: Demo example: Using image files to compare policy alternative results for Context A
    ...
    .. figure:: _static/1x1.png
        ...
        Compliance results for no-action (left) and action (right) policy alternatives
    ...
    .. figure:: _static/1x1.png
        ...
        Market class shares for no-action (left) and action (right) policy alternatives
