...
* `OMEGA Documentation in HTML format (preferred) <https://omega2.readthedocs.io/_/downloads/en/2.5.1/htmlzip/>`_

This documentation is also available online at `omega2.readthedocs.io/en/2.5.1 <https://omega2.readthedocs.io/en/2.5.1/>`_
