...
* `OMEGA Documentation in HTML format (preferred) <https://omega2.readthedocs.io/_/downloads/en/2.3.0/htmlzip/>`_

This documentation is also available online at `omega2.readthedocs.io/en/2.3.0 <https://omega2.readthedocs.io/en/2.3.0/>`_
