...
def SubconfigData_Readin_SL(rawdata_input_path, run_input_path, input_filename, output_path, \
    ...
    (FTP_array, HWFET_array) = Drive_Cycle_Differentiation_and_Integration_SL.\
        Drive_Cycle_Differentiation_and_Integration_SL(run_input_path, ftp_drivecycle_filename, hwfet_drivecycle_filename)
